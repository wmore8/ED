...
void ListLinkedSingle::intersect(const ListLinkedSingle &other) {
    ...
    while (current_this != nullptr && current_other != nullptr) {
        ...
        if (current_this->value < current_other->value) { //si el elemento de la lista1 es menor que el de la lista2
            Node* borrar = current_this;
            prev->next = current_this->next;
            current_this = current_this->next;
            delete borrar;
        }
        else if (current_this->value > current_other->value) { //si el elemento de la lista1 es mayor que el de la lista2
            current_other = current_other->next; // avanzamos para comparar el siguiente elemento
        }
    ...
    //eliminamos los nodos que sobran
